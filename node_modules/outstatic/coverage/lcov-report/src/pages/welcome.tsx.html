...
<head>
    <title>Code coverage report for src/pages/welcome.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/pages</a> welcome.tsx</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { GetServerSideProps, GetServerSidePropsContext } from 'next'
...
&nbsp;
export default function <span class="fstat-no" title="function not covered" >Welcome(</span>{ variables }: WelcomeProps) {
    ...
    &lt;&gt;
      ...
      &lt;main className="relative flex h-screen flex-col items-center justify-center z-10 p-4"&gt;
        ...
        &lt;div className="mb-20 max-w-2xl p-8 px-4 md:p-8 text-black bg-white rounded-lg border border-gray-200 shadow-md"&gt;
          ...
          &lt;/p&gt;
          &lt;ul className="mb-5"&gt;
            {Object.entries(variables.required).map(<span class="fstat-no" title="function not covered" >([</span>key, value]) =&gt; (
<span class="cstat-no" title="statement not covered" >              &lt;li key={key} className="mb-1"&gt;</span>
                {`${value ? '✅' : '❌'} Variable`}{' '}
...
&nbsp;
export const getServerSideProps: GetServerSideProps = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >as</span>ync (</span>
  context: GetServerSidePropsContext
) =&gt; {
<span class="cstat-no" title="statement not covered" >  if (!envVars.hasMissingEnvVars) {</span>
<span class="cstat-no" title="statement not covered" >    context.res.writeHead(302, {</span>
      Location: '/outstatic'
    })
<span class="cstat-no" title="statement not covered" >    context.res.end()</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  console.log({ envVars })</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return {</span>
    props: {
