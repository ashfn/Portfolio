...
<head>
    <title>Code coverage report for src/pages/settings.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/pages</a> settings.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
export default function <span class="fstat-no" title="function not covered" >Settings(</span>) {
  const { repoSlug, repoBranch, contentPath } = <span class="cstat-no" title="statement not covered" >useContext(OutstaticContext)</span>
