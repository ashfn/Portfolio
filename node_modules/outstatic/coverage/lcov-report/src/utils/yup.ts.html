...
<head>
    <title>Code coverage report for src/utils/yup.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> yup.ts</h1>
        <div class='clearfix'>
...
&nbsp;
export const editDocumentSchema: yup.SchemaOf&lt;Document&gt; = <span class="cstat-no" title="statement not covered" >yup.object().shape({</span>
