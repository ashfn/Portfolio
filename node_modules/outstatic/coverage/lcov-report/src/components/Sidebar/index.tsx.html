...
<head>
    <title>Code coverage report for src/components/Sidebar/index.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/components/Sidebar</a> index.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
const Sidebar = ({ isOpen = <span class="branch-0 cbranch-no" title="branch not covered" >false </span>}: SidebarProps) =&gt; {
  ...
  return (
    &lt;aside
      className={`absolute top-[53px] z-20 h-full w-full md:relative md:top-0 md:block md:w-64 md:min-w-[16rem]${
        isOpen ? <span class="branch-0 cbranch-no" title="branch not covered" >'block' </span>: 'hidden'
      }`}
      aria-label="Sidebar"
    &gt;
