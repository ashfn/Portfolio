...
<head>
    <title>Code coverage report for src/components/AdminHeader/index.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/components/AdminHeader</a> index.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
const AdminHeader = <span class="fstat-no" title="function not covered" >({</span>
  name,
  email,
  image,
  status,
    ...
    &lt;&gt;
      &lt;nav className="relative border-b border-gray-200 bg-white px-2 py-2.5 sm:px-4"&gt;
        &lt;div className="mx-auto flex flex-wrap items-center justify-between"&gt;
          ...
          &lt;/button&gt;
          &lt;Link href="/outstatic"&gt;
            &lt;a className="flex items-center" aria-label="Outstatic"&gt;
              &lt;svg
                fill="none"
                height="20"
                viewBox="0 0 775 135"
          ...
          {status === 'loading' || (
            &lt;div className="flex items-center md:order-2"&gt;
              &lt;button
                ...
                onClick={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >setIsOpen(!isOpen)}</span>
              &gt;
                ...
                &lt;ul className="py-1" aria-labelledby="dropdown"&gt;
                  &lt;li&gt;
                    &lt;a
                      ...
                      onClick={<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >ostSignOut()}</span>
                    &gt;
                      Sign out
                    &lt;/a&gt;
                  &lt;/li&gt;
