...
<head>
    <title>Code coverage report for src/components/PostsTable/index.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/components/PostsTable</a> index.tsx</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >                    setPosts(posts.filter(<span class="fstat-no" title="function not covered" >(p</span>) =&gt; <span class="cstat-no" title="statement not covered" >p.slug !== slug)</span>)</span>
                  }
