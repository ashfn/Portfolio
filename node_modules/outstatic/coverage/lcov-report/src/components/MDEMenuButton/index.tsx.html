...
<head>
    <title>Code coverage report for src/components/MDEMenuButton/index.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/components/MDEMenuButton</a> index.tsx</h1>
        <div class='clearfix'>
...
const MDEMenuButton = ({
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (htmlFor) {
<span class="cstat-no" title="statement not covered" >    inputProps.htmlFor = htmlFor</span>
  }
  return (
    &lt;Tag
...
<span class="cstat-no" title="statement not covered" >        onClick()</span>
      ...
      className={`group border-r border-black py-2 px-3 last-of-type:border-r-0 disabled:cursor-not-allowed disabled:hover:bg-gray-600 ${
        editor.isActive(name, attributes)
          ? <span class="branch-0 cbranch-no" title="branch not covered" >'is-active bg-black text-white [&amp;&gt;svg]:fill-white'</span>
