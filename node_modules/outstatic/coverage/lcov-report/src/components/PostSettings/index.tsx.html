...
<head>
    <title>Code coverage report for src/components/PostSettings/index.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/components/PostSettings</a> index.tsx</h1>
        <div class='clearfix'>
    ...
    &lt;aside className="relative w-full border-b border-gray-300 bg-white md:w-64 md:flex-none md:flex-col md:flex-wrap md:items-start md:justify-start md:border-b-0 md:border-l md:py-6 max-h-[calc(100vh-53px)]"&gt;
      &lt;div className="relative hidden w-full items-center justify-between md:mb-4 md:flex px-4"&gt;
        &lt;DateTimePicker
          ...
          setDate={<span class="fstat-no" title="function not covered" >(p</span>ublishedAt) =&gt; <span class="cstat-no" title="statement not covered" >editPost('publishedAt', publishedAt)}</span>
        /&gt;
      &lt;/div&gt;
      &lt;div className="relative hidden w-full items-center justify-between md:mb-4 md:flex px-4"&gt;
        &lt;label
      ...
      &gt;
        {showDelete &amp;&amp; (
<span class="branch-1 cbranch-no" title="branch not covered" >          &lt;DeletePostButton</span>
            disabled={loading}
            slug={post.slug}
...
<span class="cstat-no" title="statement not covered" >                editPost(</span>
                  'slug',
                  lastChar === ' ' || lastChar === '-'
                    ? e.target.value
