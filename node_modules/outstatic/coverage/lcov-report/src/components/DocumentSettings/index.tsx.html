...
<head>
    <title>Code coverage report for src/components/DocumentSettings/index.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/components/DocumentSettings</a> index.tsx</h1>
        <div class='clearfix'>
    ...
    &lt;aside className="relative w-full border-b border-gray-300 bg-white md:w-64 md:flex-none md:flex-col md:flex-wrap md:items-start md:justify-start md:border-b-0 md:border-l md:py-6 max-h-[calc(100vh-53px)] scrollbar-hide overflow-scroll"&gt;
      &lt;div className="relative hidden w-full items-center justify-between md:mb-4 md:flex px-4"&gt;
        &lt;DateTimePicker
          ...
          setDate={<span class="fstat-no" title="function not covered" >(p</span>ublishedAt) =&gt; <span class="cstat-no" title="statement not covered" >editDocument('publishedAt', publishedAt)}</span>
        /&gt;
      &lt;/div&gt;
      &lt;div className="relative hidden w-full items-center justify-between md:mb-4 md:flex px-4"&gt;
        &lt;label
      ...
      &lt;div
        className={`flex w-full pb-4 px-4 ${
          showDelete ? <span class="branch-0 cbranch-no" title="branch not covered" >'justify-between items-center' </span>: 'justify-end'
        }`}
      &gt;
        {showDelete &amp;&amp; (
<span class="branch-1 cbranch-no" title="branch not covered" >          &lt;DeleteDocumentButton</span>
            disabled={loading}
            slug={document.slug}
          ...
          &lt;Input
            ...
            validation={{
              onChange: <span class="fstat-no" title="function not covered" >(e</span>) =&gt; {
                const lastChar = <span class="cstat-no" title="statement not covered" >e.target.value.slice(-1)</span>
<span class="cstat-no" title="statement not covered" >                editDocument(</span>
                  'slug',
                  lastChar === ' ' || lastChar === '-'
                    ? e.target.value
