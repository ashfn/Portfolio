...
<head>
    <title>Code coverage report for src/components/Input/index.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/components/Input</a> index.tsx</h1>
        <div class='clearfix'>
...
export default function Input({
  ...
  wrapperClass,
  className,
  inputSize = <span class="branch-0 cbranch-no" title="branch not covered" >'medium',</span>
  ...rest
}: InputProps) {
  const {
    register,
...
<span class="branch-2 cbranch-no" title="branch not covered" >          &lt;div className="mt-1"&gt;</span>
            {helperText &amp;&amp; (
