...
<head>
    <title>Code coverage report for src/components/Accordion/index.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/components/Accordion</a> index.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
  const handleShow = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >    setShow(!show)</span>
    ...
    &lt;div className="w-full border-b first:border-t"&gt;
      &lt;h2 id="accordion-collapse-heading-1"&gt;
        ...
        &gt;
          ...
          &lt;svg
            data-accordion-icon
            className={`w-6 h-6 shrink-0 ${show ? <span class="branch-0 cbranch-no" title="branch not covered" >'' </span>: 'rotate-180'}`}
            fill="currentColor"
            viewBox="0 0 20 20"
        ...
        &lt;/button&gt;
      &lt;/h2&gt;
      &lt;div className={show ? <span class="branch-0 cbranch-no" title="branch not covered" >'block' </span>: 'hidden'}&gt;
