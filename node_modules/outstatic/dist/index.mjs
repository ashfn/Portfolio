...
var OutstaticProvider = ({
  ...
  return /* @__PURE__ */ jsx(OutstaticContext.Provider, {
    value: {
      repoOwner: repoOwner || "",
      repoSlug: repoSlug || "",
...
async function getSession() {
  const response = await fetch2("/api/outstatic/user");
...
import { useContext as useContext9, useEffect as useEffect5, useState as useState11 } from "react";
import { FormProvider, useForm } from "react-hook-form";
import { convert as convert3 } from "url-slug";
    ...
    children: /* @__PURE__ */ jsx3("nav", {
      ...
      children: /* @__PURE__ */ jsxs2("div", {
        ...
        children: [
          ...
          status === "loading" || /* @__PURE__ */ jsxs2("div", {
      ...
      /* @__PURE__ */ jsx4("div", {
        ...
        children: /* @__PURE__ */ jsxs3("ul", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx4(Fragment3, {
              children: collections.map((collection) => /* @__PURE__ */ jsx4("li", {
                children: /* @__PURE__ */ jsx4(Link2, {
...
function AdminLayout({
  ...
  return /* @__PURE__ */ jsxs4(Fragment4, {
    children: [
      /* @__PURE__ */ jsx5(Head2, {
        children: /* @__PURE__ */ jsx5("title", {
          children: title ? `${title} | Outstatic` : "Outstatic"
        })
      }),
      status === "loading" ? null : /* @__PURE__ */ jsxs4("div", {
        className: "flex h-screen flex-col bg-white text-black",
        children: [
          /* @__PURE__ */ jsx5(AdminHeader_default, {
...
function Input({
  ...
  return /* @__PURE__ */ jsxs5("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx6(Fragment5, {
        children: (((_a = errors[id]) == null ? void 0 : _a.message) || helperText) && /* @__PURE__ */ jsxs5("div", {
          className: "mt-1",
          children: [
            helperText && /* @__PURE__ */ jsx6("p", {
              className: "text-xs text-gray-500",
              children: helperText
            }),
            ((_b = errors[id]) == null ? void 0 : _b.message) && /* @__PURE__ */ jsx6("span", {
...
import { useCallback, useContext as useContext2, useState as useState3 } from "react";
...
var MDEInsertImage = ({ editor, setImageMenu }) => {
  const { setFiles } = useContext2(PostContext);
  const [showLink, setShowLink] = useState3(false);
  const [imageUrl, setImageUrl] = useState3("");
  const [errors, setErrors] = useState3({ imageUrl: "", uploadImage: "" });
  ...
  return /* @__PURE__ */ jsx8(Fragment6, {
    children: showLink ? /* @__PURE__ */ jsxs6("div", {
      className: "flex w-[500px] rounded-sm border border-black outline-none",
      children: [
        /* @__PURE__ */ jsx8(MDEMenuButton_default, {
        ...
        /* @__PURE__ */ jsxs6("div", {
          ...
          children: [
            ...
            errors.imageUrl && /* @__PURE__ */ jsx8("span", {
...
var MDEFloatingMenu = ({ editor }) => {
  const [imageMenu, setImageMenu] = useState4(false);
  return /* @__PURE__ */ jsx9(Fragment7, {
    children: /* @__PURE__ */ jsx9(FloatingMenu, {
      editor,
      tippyOptions: {
        duration: 100,
      ...
      className: "prose-sm",
      children: !imageMenu ? /* @__PURE__ */ jsxs7("div", {
        className: "rounded-sm border border-black",
        children: [
          /* @__PURE__ */ jsx9(MDEMenuButton_default, {
      ...
      }) : /* @__PURE__ */ jsx9(MDEInsertImage_default, {
        editor,
        setImageMenu
      })
    })
...
import { useCallback as useCallback2, useContext as useContext3, useState as useState5 } from "react";
import { Fragment as Fragment8, jsx as jsx10, jsxs as jsxs8 } from "react/jsx-runtime";
var MDEUImageMenu = ({ editor, setImageSelected }) => {
  const { setFiles } = useContext3(PostContext);
  const [showLink, setShowLink] = useState5(false);
  const [url, setUrl] = useState5("");
  const [showAltText, setShowAltText] = useState5(false);
  const [altText, setAltText] = useState5("");
  ...
  return /* @__PURE__ */ jsxs8(Fragment8, {
    children: [
      showAltText && /* @__PURE__ */ jsxs8(Fragment8, {
        children: [
          /* @__PURE__ */ jsx10(MDEMenuButton_default, {
            onClick: () => {
              setShowAltText(false);
              setImageSelected(true);
            },
      ...
      showLink && /* @__PURE__ */ jsxs8(Fragment8, {
        children: [
          /* @__PURE__ */ jsx10(MDEMenuButton_default, {
            onClick: () => {
      ...
      !showAltText && !showLink && /* @__PURE__ */ jsxs8(Fragment8, {
        children: [
          /* @__PURE__ */ jsx10(MDEMenuButton_default, {
            onClick: () => {
...
import { useCallback as useCallback3, useEffect as useEffect2, useState as useState6 } from "react";
import { Fragment as Fragment9, jsx as jsx11, jsxs as jsxs9 } from "react/jsx-runtime";
var MDEMenu = ({ editor }) => {
  const [imageSelected, setImageSelected] = useState6(false);
  const [showLink, setShowLink] = useState6(false);
  ...
  return /* @__PURE__ */ jsx11(BubbleMenu, {
    editor,
    tippyOptions: {
      duration: 100,
      maxWidth: 500,
    ...
    children: /* @__PURE__ */ jsxs9("div", {
      ...
      children: [
        showLink && /* @__PURE__ */ jsxs9(Fragment9, {
          children: [
            /* @__PURE__ */ jsx11(MDEMenuButton_default, {
              onClick: () => {
                setShowLink(false);
              },
              editor,
        ...
        imageSelected && /* @__PURE__ */ jsx11(MDEImageMenu_default, {
          editor,
          setImageSelected
        }),
        !imageSelected && !showLink && /* @__PURE__ */ jsxs9(Fragment9, {
          children: [
            /* @__PURE__ */ jsx11(MDEMenuButton_default, {
...
import { Fragment as Fragment10, jsx as jsx12, jsxs as jsxs10 } from "react/jsx-runtime";
var MDEditor = ({ id, editor }) => {
  ...
  return /* @__PURE__ */ jsxs10(Fragment10, {
    children: [
      editor && /* @__PURE__ */ jsx12(MDEMenu_default, {
        editor
      }),
      editor && /* @__PURE__ */ jsx12(MDEFloatingMenu_default, {
        editor
      }),
      /* @__PURE__ */ jsx12(EditorContent, {
        name: "content",
        value: watchContent,
        editor
      }),
      /* @__PURE__ */ jsx12("div", {
        className: "mt-1",
        children: ((_a = errors[id]) == null ? void 0 : _a.message) && /* @__PURE__ */ jsx12("span", {
          className: "text-sm text-red-500",
...
import { Fragment as Fragment11, jsx as jsx14, jsxs as jsxs12 } from "react/jsx-runtime";
var options = {
  year: "numeric",
  month: "long",
  day: "numeric"
...
var DateTimePicker = ({ date: date2, setDate, id, label }) => {
  const DatePickerButton = (props, ref) => /* @__PURE__ */ jsx14("button", {
    ...props,
    ref,
  ...
  return /* @__PURE__ */ jsxs12(Fragment11, {
    children: [
      label && /* @__PURE__ */ jsx14("label", {
        className: "block text-sm font-medium text-gray-900",
        htmlFor: id,
        children: label
      }),
      /* @__PURE__ */ jsx14("div", {
        children: /* @__PURE__ */ jsx14(Datepicker, {
          name: id,
          selected: date2,
          onChange: (date3) => {
            setDate(date3);
          ...
          renderCustomHeader: ({
            ...
            children: [
              ...
              /* @__PURE__ */ jsx14("select", {
                ...
                children: months.map((option) => /* @__PURE__ */ jsx14("option", {
                  value: option,
                  children: option
                }, option))
              }),
...
var useOid = () => {
  var _a;
  const { repoSlug, repoOwner } = useContext4(OutstaticContext);
...
var Modal = ({ children, title, close }) => /* @__PURE__ */ jsx15("div", {
...
// src/components/DeletePostButton/index.tsx
import { Fragment as Fragment12, jsx as jsx16, jsxs as jsxs14 } from "react/jsx-runtime";
var DeletePostButton = ({
  ...
  const [showDeleteModal, setShowDeleteModal] = useState8(false);
  const [deleting, setDeleting] = useState8(false);
  const { session } = useOstSession();
  const [createCommit] = useCreateCommitMutation();
  const { repoOwner, repoSlug, contentPath, monorepoPath } = useContext5(OutstaticContext);
  ...
  return /* @__PURE__ */ jsxs14(Fragment12, {
    children: [
      ...
      showDeleteModal && /* @__PURE__ */ jsxs14(Modal_default, {
        title: "Delete Post",
          ...
          /* @__PURE__ */ jsxs14("div", {
            ...
            children: [
              /* @__PURE__ */ jsx16("button", {
                ...
                children: deleting ? /* @__PURE__ */ jsxs14(Fragment12, {
                  children: [
                    /* @__PURE__ */ jsxs14("svg", {
...
function TextArea({
  ...
  return /* @__PURE__ */ jsxs15("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx17("div", {
        className: "relative",
        children: /* @__PURE__ */ jsx17("textarea", {
          ...register(id, validation),
          ...rest,
          name: id,
          id,
      ...
      /* @__PURE__ */ jsxs15("div", {
        className: "mt-1",
        children: [
          helperText && /* @__PURE__ */ jsx17("p", {
            className: "text-xs text-gray-500",
            children: helperText
          }),
          ((_a = errors[id]) == null ? void 0 : _a.message) && /* @__PURE__ */ jsx17("span", {
            className: "text-sm text-red-500",
            children: (_c = (_b = errors[id]) == null ? void 0 : _b.message) == null ? void 0 : _c.toString()
          })
        ]
...
import { useContext as useContext6, useEffect as useEffect3, useState as useState9 } from "react";
import { Fragment as Fragment13, jsx as jsx18, jsxs as jsxs16 } from "react/jsx-runtime";
...
var PostSettingsImageSelection = ({
  ...
  const { post, editPost, setFiles } = useContext6(PostContext);
  const [showImage, setShowImage] = useState9(false);
  const [showImageOptions, setShowImageOptions] = useState9(false);
  const [showLink, setShowLink] = useState9(false);
  const [previewLoading, setPreviewLoading] = useState9(true);
  const [loadingError, setLoadingError] = useState9(false);
  const [image, setImage] = useState9("");
  ...
  return /* @__PURE__ */ jsxs16(Fragment13, {
    children: [
      loadingError && /* @__PURE__ */ jsx18("div", {
        className: "p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800",
        role: "alert",
        children: "The image failed to load, try submitting again."
      }),
      showImage && /* @__PURE__ */ jsxs16(Fragment13, {
        children: [
          /* @__PURE__ */ jsx18("div", {
            className: "mb-1 block text-sm font-medium text-gray-900",
          ...
          /* @__PURE__ */ jsxs16("div", {
            ...
            children: [
              previewLoading && /* @__PURE__ */ jsx18("div", {
      ...
      showLink && /* @__PURE__ */ jsxs16(Fragment13, {
        children: [
      ...
      showImageOptions && /* @__PURE__ */ jsxs16(Fragment13, {
        children: [
          /* @__PURE__ */ jsx18("span", {
            className: "mb-1 block text-sm font-medium text-gray-900",
...
// src/components/PostSettings/index.tsx
import { Fragment as Fragment14, jsx as jsx19, jsxs as jsxs17 } from "react/jsx-runtime";
var PostSettings = ({
  saveFunc,
  loading,
  validation,
  ...
  const router3 = useRouter2();
  const { post, editPost, hasChanges, collection } = useContext7(PostContext);
  return /* @__PURE__ */ jsxs17("aside", {
    ...
    children: [
      /* @__PURE__ */ jsx19("div", {
        ...
        children: /* @__PURE__ */ jsx19(DateTimePicker_default, {
          id: "publishedAt",
          label: "Date",
      ...
      /* @__PURE__ */ jsxs17("div", {
        ...
        children: [
          showDelete && /* @__PURE__ */ jsx19(DeletePostButton_default, {
            disabled: loading,
            slug: post.slug,
            onComplete: () => {
          ...
          /* @__PURE__ */ jsx19("button", {
            ...
            children: loading ? /* @__PURE__ */ jsxs17(Fragment14, {
              children: [
                /* @__PURE__ */ jsxs17("svg", {
                  className: "mr-3 -ml-1 h-5 w-5 animate-spin text-white",
                  xmlns: "http://www.w3.org/2000/svg",
      ...
      /* @__PURE__ */ jsxs17("div", {
        className: "w-full",
        children: [
          /* @__PURE__ */ jsxs17(Accordion_default, {
            title: "Author",
            children: [
              ...
              /* @__PURE__ */ jsx19(PostSettingsImageSelection_default, {
                label: "Add an avatar",
                name: "author.picture",
          ...
          /* @__PURE__ */ jsx19(Accordion_default, {
            title: "URL Slug",
          ...
          /* @__PURE__ */ jsx19(Accordion_default, {
            title: "Description",
            children: /* @__PURE__ */ jsx19(TextArea, {
              name: "description",
              type: "textarea",
          ...
          /* @__PURE__ */ jsx19(Accordion_default, {
            title: "Cover Image",
            children: /* @__PURE__ */ jsx19(PostSettingsImageSelection_default, {
              name: "coverImage",
...
function PostTitle({
  ...
  const { editor } = useContext8(PostContext);
  return /* @__PURE__ */ jsxs18("div", {
    className: wrapperClass,
    children: [
      /* @__PURE__ */ jsx20("div", {
        className: "relative",
        children: /* @__PURE__ */ jsx20(TextareaAutosize, {
          ...register(id, {
            onChange: (e) => {
              ...
              if (last === "new") {
                setValue(
                  "slug",
                  convert2(e.target.value, { dictionary: { "'": "" } })
                );
              }
            }
          }),
      ...
      /* @__PURE__ */ jsxs18("div", {
        className: "mt-1",
        children: [
          helperText && /* @__PURE__ */ jsx20("p", {
            className: "text-xs text-gray-500",
            children: helperText
          }),
          ((_a = errors[id]) == null ? void 0 : _a.message) && /* @__PURE__ */ jsx20("span", {
            className: "text-sm text-red-500",
            children: (_c = (_b = errors[id]) == null ? void 0 : _b.message) == null ? void 0 : _c.toString()
          })
        ]
...
var PostsTable = (props) => {
  const [posts, setPosts] = useState10(props.posts);
  return /* @__PURE__ */ jsxs19("table", {
    className: "w-full text-left text-sm text-gray-500",
    children: [
      /* @__PURE__ */ jsx21("thead", {
        className: "bg-gray-50 text-xs uppercase text-gray-700 border-b",
        children: /* @__PURE__ */ jsxs19("tr", {
          children: [
            /* @__PURE__ */ jsx21("th", {
              scope: "col",
              className: "px-6 py-3",
      ...
      /* @__PURE__ */ jsx21("tbody", {
        children: posts && posts.map(({ slug, title, status, publishedAt }) => /* @__PURE__ */ jsxs19("tr", {
          className: "border-b bg-white hover:bg-gray-50",
          children: [
            /* @__PURE__ */ jsx21("th", {
              scope: "row",
              className: "relative whitespace-nowrap px-6 py-4 text-base font-semibold text-gray-900 group",
              children: /* @__PURE__ */ jsx21(Link3, {
            ...
            /* @__PURE__ */ jsx21("td", {
              ...
              children: /* @__PURE__ */ jsx21(DeletePostButton_default, {
                slug,
                disabled: false,
...
// src/pages/edit-collection/index.tsx
import { Fragment as Fragment15, jsx as jsx22, jsxs as jsxs20 } from "react/jsx-runtime";
function EditCollection() {
  const {
    ...
    repoOwner,
    addPage
  } = useContext9(OutstaticContext);
  const router3 = useRouter4();
  const [createCommit] = useCreateCommitMutation();
  const fetchOid = useOid_default();
  const [hasChanges, setHasChanges] = useState11(false);
  const [pluralized, setPlural] = useState11("");
  ...
  const onSubmit = async ({ name }) => {
    ...
    try {
      const oid = await fetchOid();
      const owner = repoOwner || ((_a = session == null ? void 0 : session.user) == null ? void 0 : _a.login) || "";
      const collection = convert3(name, { dictionary: { "'": "" } });
  ...
  return /* @__PURE__ */ jsx22(FormProvider, {
    ...methods,
    children: /* @__PURE__ */ jsxs20(AdminLayout, {
      title: "New Collection",
      children: [
        /* @__PURE__ */ jsx22("div", {
          className: "mb-8 flex h-12 items-center",
          children: /* @__PURE__ */ jsx22("h1", {
            className: "mr-12 text-2xl",
            children: "Create a Collection"
          })
        }),
        /* @__PURE__ */ jsxs20("form", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx22("button", {
              ...
              children: loading ? /* @__PURE__ */ jsxs20(Fragment15, {
                children: [
                  /* @__PURE__ */ jsxs20("svg", {
                    className: "mr-3 -ml-1 h-5 w-5 animate-spin text-white",
                    xmlns: "http://www.w3.org/2000/svg",
        ...
        pluralized && /* @__PURE__ */ jsxs20("div", {
...
import { useContext as useContext10, useState as useState12 } from "react";
import { Fragment as Fragment16, jsx as jsx23, jsxs as jsxs21 } from "react/jsx-runtime";
function Collections() {
  const {
    ...
    monorepoPath,
    removePage
  } = useContext10(OutstaticContext);
  const [showDeleteModal, setShowDeleteModal] = useState12(false);
  const [selectedCollection, setSelectedCollection] = useState12("");
  ...
  return /* @__PURE__ */ jsxs21(AdminLayout, {
    title: "Collections",
    children: [
      collections.length === 0 ? /* @__PURE__ */ jsxs21("div", {
        className: "max-w-2xl",
        children: [
          /* @__PURE__ */ jsx23("div", {
            className: "absolute bottom-0 left-0 md:left-64 right-0 md:top-36",
            children: /* @__PURE__ */ jsx23("svg", {
              fill: "none",
        ...
        children: [
          ...
          /* @__PURE__ */ jsx23("div", {
            ...
            children: collections.map((collection) => /* @__PURE__ */ jsxs21("div", {
      ...
      showDeleteModal && /* @__PURE__ */ jsxs21(Modal_default, {
          ...
          /* @__PURE__ */ jsxs21("div", {
            ...
            children: [
              /* @__PURE__ */ jsx23("button", {
                ...
                children: deleting ? /* @__PURE__ */ jsxs21(Fragment16, {
                  children: [
                    /* @__PURE__ */ jsxs21("svg", {
                      className: "mr-3 -ml-1 h-5 w-5 animate-spin text-white",
                      xmlns: "http://www.w3.org/2000/svg",
...
import { useContext as useContext11, useEffect as useEffect6, useState as useState13 } from "react";
import { FormProvider as FormProvider2, useForm as useForm2 } from "react-hook-form";
import showdown2 from "showdown";
  ...
  return /* @__PURE__ */ jsxs22(NodeViewWrapper, {
    ...
    children: [
      /* @__PURE__ */ jsx24("div", {
        ...
        children: /* @__PURE__ */ jsxs22("select", {
          ...
          children: [
            ...
            extension.options.lowlight.listLanguages().map((lang, index) => /* @__PURE__ */ jsx24("option", {
              value: lang,
              children: lang
            }, index))
          ]
      ...
      /* @__PURE__ */ jsx24("pre", {
        ...
        children: /* @__PURE__ */ jsx24(NodeViewContent, {
          as: "code"
        })
      })
    ]
...
var useTipTap = ({ ...rhfMethods }) => {
  ...
  const editor = useEditor({
    extensions: [
      ...
      Link5.configure({ openOnClick: false }),
...
// src/pages/edit-document/index.tsx
import { Fragment as Fragment17, jsx as jsx25, jsxs as jsxs23 } from "react/jsx-runtime";
function EditDocument({ collection }) {
  var _a, _b, _c;
  const router3 = useRouter5();
  const slug = (_b = (_a = router3.query) == null ? void 0 : _a.ost) == null ? void 0 : _b[1];
  const { repoOwner, repoSlug, contentPath, monorepoPath } = useContext11(OutstaticContext);
  const { session } = useOstSession();
  const [loading, setLoading] = useState13(false);
  const [hasChanges, setHasChanges] = useState13(false);
  const [files, setFiles] = useState13([]);
  const [createCommit] = useCreateCommitMutation();
  const fetchOid = useOid_default();
  const [showDelete, setShowDelete] = useState13(false);
  const methods = useForm2({ resolver: yupResolver2(editPostSchema) });
  ...
  useEffect6(() => {
    ...
    if ((postQueryObject == null ? void 0 : postQueryObject.__typename) === "Blob") {
      ...
      const parseContent = () => {
        const converter = new showdown2.Converter({ noHeaderId: true });
  ...
  useNavigationLock_default(hasChanges);
  return /* @__PURE__ */ jsxs23(Fragment17, {
    children: [
      /* @__PURE__ */ jsxs23(Head3, {
        children: [
          /* @__PURE__ */ jsx25("link", {
            rel: "preconnect",
      ...
      /* @__PURE__ */ jsx25(PostContext.Provider, {
        value: {
          editor,
        ...
        children: /* @__PURE__ */ jsx25(FormProvider2, {
          ...methods,
          children: /* @__PURE__ */ jsx25(AdminLayout, {
            title: methods.getValues("title"),
            settings: /* @__PURE__ */ jsx25(PostSettings_default, {
              loading,
              saveFunc: methods.handleSubmit(onSubmit),
              showDelete
            }),
            children: /* @__PURE__ */ jsxs23("form", {
              className: "m-auto max-w-[700px] space-y-4",
              children: [
                /* @__PURE__ */ jsx25(PostTitle, {
                  id: "title",
                ...
                /* @__PURE__ */ jsx25("div", {
                  ...
                  children: /* @__PURE__ */ jsx25(MDEditor_default, {
                    editor,
                    id: "content"
                  })
                })
...
function List({ collection }) {
  var _a, _b, _c, _d, _e;
  const { repoOwner, repoSlug, contentPath, monorepoPath, session } = useContext12(OutstaticContext);
  ...
  return /* @__PURE__ */ jsxs24(AdminLayout, {
    error,
    ...
    children: [
      /* @__PURE__ */ jsxs24("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx26(Link6, {
            href: `/outstatic/${collection}/new`,
            children: /* @__PURE__ */ jsxs24("a", {
      ...
      posts.length > 0 && /* @__PURE__ */ jsx26("div", {
        className: "relative overflow-x-auto shadow-md sm:rounded-lg",
        children: /* @__PURE__ */ jsx26(PostsTable_default, {
          posts,
          collection
        })
      }),
      posts.length === 0 && !loading && /* @__PURE__ */ jsxs24("div", {
        className: "max-w-2xl",
        children: [
          /* @__PURE__ */ jsx26("div", {
            className: "absolute bottom-0 left-0 md:left-64 right-0 md:top-36",
            children: /* @__PURE__ */ jsx26("svg", {
              fill: "none",
              className: "h-full w-full",
              xmlns: "http://www.w3.org/2000/svg",
...
import { Fragment as Fragment18, jsx as jsx27, jsxs as jsxs25 } from "react/jsx-runtime";
function Login() {
  return /* @__PURE__ */ jsxs25(Fragment18, {
    children: [
      /* @__PURE__ */ jsx27(Head4, {
        children: /* @__PURE__ */ jsx27("title", {
          children: "Login to Outstatic"
        })
      }),
      /* @__PURE__ */ jsx27("div", {
        className: "absolute bottom-10 w-full left-0 overflow-hidden z-0 md:-top-10",
        children: /* @__PURE__ */ jsx27("svg", {
          width: "100%",
          height: "100%",
          viewBox: "0 0 1200 365",
          fill: "none",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs25("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx27(Link7, {
                href: "/api/outstatic/login",
                children: /* @__PURE__ */ jsxs25("a", {
...
function Settings() {
  const { repoSlug, contentPath } = useContext13(OutstaticContext);
  return /* @__PURE__ */ jsxs26(AdminLayout, {
    title: "Settings",
    children: [
      /* @__PURE__ */ jsx28("div", {
        className: "mb-8 flex h-12 items-center",
        children: /* @__PURE__ */ jsx28("h1", {
          className: "mr-12 text-2xl",
          children: "Settings"
        })
      }),
...
import Head5 from "next/head";
import { Fragment as Fragment19, jsx as jsx29, jsxs as jsxs27 } from "react/jsx-runtime";
function Welcome({ variables }) {
  return /* @__PURE__ */ jsxs27(Fragment19, {
    children: [
      /* @__PURE__ */ jsx29(Head5, {
        children: /* @__PURE__ */ jsx29("title", {
          children: "Welcome to Outstatic"
        })
      }),
      /* @__PURE__ */ jsx29("div", {
        className: "absolute bottom-10 w-full left-0 overflow-hidden z-0 md:-top-10",
        children: /* @__PURE__ */ jsx29("svg", {
          width: "100%",
          height: "100%",
          viewBox: "0 0 1200 365",
          fill: "none",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs27("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx29("ul", {
                className: "mb-5",
                children: Object.entries(variables.required).map(([key, value]) => /* @__PURE__ */ jsxs27("li", {
                  className: "mb-1",
                  children: [
                    `${value ? "\u2705" : "\u274C"} Variable`,
                    " ",
              ...
              !variables.optional.OST_CONTENT_PATH && /* @__PURE__ */ jsxs27("p", {
              ...
              !variables.optional.OST_REPO_OWNER && /* @__PURE__ */ jsxs27("p", {
                className: "mb-5 p-2 bg-blue-100 rounded",
                children: [
                  "Optional variable",
                  " ",
...
var defaultPages = {
  settings: /* @__PURE__ */ jsx30(Settings, {}),
  collections: void 0
};
var Outstatic = ({ missingEnvVars, providerData }) => {
  var _a, _b, _c, _d;
  const [pages2, setPages] = useState14(providerData == null ? void 0 : providerData.pages);
  const [collections, setCollections] = useState14(providerData == null ? void 0 : providerData.collections);
  const router3 = useRouter6();
  ...
  if (missingEnvVars)
    return /* @__PURE__ */ jsx30(Welcome, {
      variables: missingEnvVars
    });
  const { session } = providerData;
  if (!session) {
    return /* @__PURE__ */ jsx30(Login, {});
  }
  ...
  if (slug && !pages2.includes(slug)) {
    return /* @__PURE__ */ jsx30(FourOhFour, {});
  }
  const isContent = slug && collections.includes(slug);
  return /* @__PURE__ */ jsx30(OutstaticProvider, {
    ...providerData,
    pages: pages2,
    collections,
    addPage,
    removePage,
    children: /* @__PURE__ */ jsxs28(ApolloProvider, {
      client,
      children: [
        !slug && /* @__PURE__ */ jsx30(Collections, {}),
        slug2 && isContent && /* @__PURE__ */ jsx30(EditDocument, {
          collection: slug
        }),
        !slug2 && isContent ? /* @__PURE__ */ jsx30(List, {
          collection: slug
        }) : defaultPages[slug],
        !!slug2 && !isContent && /* @__PURE__ */ jsx30(EditCollection, {})
      ]
    })
  });
};
...
import { createRouter as createRouter2 } from "next-connect";
var router2 = createRouter2();
