...
declare type DocumentContextType = {
    editor: Editor;
    document: Document;
...
declare const Outstatic: ({ missingEnvVars, providerData }: OutstaticProps) => JSX.Element | null;
...
declare const OutstaticProvider: ({ children, repoOwner, repoSlug, repoBranch, contentPath, monorepoPath, session, collections, pages, addPage, removePage }: OutstaticProviderProps) => JSX.Element;
declare const DocumentContext: react.Context<DocumentContextType>;

export { Collection, Document, DocumentContext, DocumentContextType, FileType, OstSSP, Outstatic, OutstaticApi, OutstaticContext, OutstaticProvider, Session };
